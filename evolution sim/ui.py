...
def get_averages(slimes,surface,font):
    ...
    avg_meta = round(total_energy_efficiency / count, 2)
...
def draw_stats(surface, font, slimes, start_stats, total_death_from_age, total_starvations):
    ...
    count, avg_speed, avg_size, avg_sight, avg_eff, avg_age, avg_lifespan = get_averages(slimes,surface,font)
    ...
    eff_text = font.render(f"Avg energy efficiency: {avg_eff}, Start: {s_efficiency}", True, (255, 255, 255))
    ...
    surface.blit(eff_text, (x_pos, y_pos + line_height * 4))
